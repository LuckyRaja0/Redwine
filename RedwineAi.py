...
┏━━━━━━━━━━━━━━━━━┓
┣★ ᴄʀᴇᴀᴛᴇʀ [𝙏𝙄𝙈𝙀 𝙋𝘼𝙎𝙎](https://t.me/Time_Pass_Back)
┣★ ʙᴏᴛ ᴜᴘᴅᴀᴛᴇs [ᴏᴜʀ ᴏᴛʜᴇʀ ʙᴏᴛs](https://t.me/+g0YcEKl54yU0ZTU9)
┣★ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ [ᴄʜᴀᴛ](https://t.me/+iG7cgnoRiKhlMzU1)
┗━━━━━━━━━━━━━━━━━┛
🥵
IF HAVE ANY QUESTION THEN CONTACT » TO » MY » [OWNER] @itz_Lucky_Raja""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("💟 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 💟", url=f"https://t.me/+LHcxarl1geQyYWM1")]]
        ),
    ) 
...
async def queenai(client: Client, message: Message):
   ...
   if not message.reply_to_message:
       redwinedb = MongoClient(MONGO_URL)
       redwine = redwinedb["RedwineDb"]["Redwine"] 
       is_redwine = redwine.find_one({"chat_id": message.chat.id})
       if not is_redwine:
...
async def redwineprivate(client: Client, message: Message):
